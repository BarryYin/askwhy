...
def main():
    ...
    with st.sidebar:
        selected = option_menu("一站到底", ["登录","十万个为什么","基础问答",'两人PK擂台','50选1','排行榜','查看答案'], 
            icons=['piggy-bank','house', 'gear', 'clipboard-data','people',"list-task","arrow-up-right-circle"], menu_icon="cast", default_index=0,
            styles={
